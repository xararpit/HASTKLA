        ...
        <>
            ...
            <div className="container py-2xl max-w-3xl" style={{ maxWidth: '800px' }}>
                ...
                <div className="card mb-xl p-xl">
                    <h2 className="mb-md text-primary" style={{ color: 'var(--color-primary-dark)' }}>Shipping Policy</h2>
                ...
                <div className="card mb-xl p-xl">
                    <h2 className="mb-md text-primary" style={{ color: 'var(--color-primary-dark)' }}>Refund & Return Policy</h2>
                ...
                <div className="card p-xl">
                    <h2 className="mb-md text-primary" style={{ color: 'var(--color-primary-dark)' }}>Customization Terms</h2>
