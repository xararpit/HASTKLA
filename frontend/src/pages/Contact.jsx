                    ...
                    <div className="contact-info">
                        <div className="card mb-lg p-xl">
                            ...
                            <div className="contact-detail flex gap-md items-center mb-md">
                                <div style={{ width: '40px', height: '40px', backgroundColor: 'var(--color-primary-light, #C4622D)', borderRadius: '50%', color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                    <span>&#9993;</span>
                                </div>
                                <div>
                                    <h4 className="m-0 text-sm italic text-muted">Email</h4>
                                    <p className="m-0 font-medium">hello@hastkla.in</p>
                                </div>
                            </div>
